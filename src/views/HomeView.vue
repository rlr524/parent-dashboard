								...
								<blockquote>
									<div>
										<p class="text-base text-gray-500">
											...
											rhoncus lacus ultrices sed diam. Sit
											orci risus aenean curabitur donec
											aliquet. Mi venenatis in euismod
											ut.&rdquo;
										</p>
									</div>
									<footer class="mt-3">
			...
			<div class="bg-gradient-to-r from-purple-800 to-indigo-700">
				...
				>
					...
					<p class="mt-4 max-w-3xl text-lg text-purple-200">
						...
						rhoncus. Et magna sit morbi lobortis. Blandit aliquam
				...
				>
					...
					>
						...
						<p class="mt-5 text-lg text-gray-300">
							Rhoncus sagittis risus arcu erat lectus bibendum. Ut
							in adipiscing quis in viverra tristique sem. Ornare
							feugiat viverra eleifend fusce orci in quis amet.
							Sit in et vitae tortor, massa. Dapibus laoreet amet
							lacus nibh integer quis. Eu vulputate diam sit
							tellus quis at.
						</p>
						<div
							...
							<p>
								...
								<span class="mt-1 block text-base text-gray-300"
									><span class="font-medium text-white"
										>Companies</span
									>
									use laoreet amet lacus nibh integer
									quis.</span
								>
							</p>
